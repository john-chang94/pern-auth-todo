...
const EditTodo = ({ todo, setTodosChange }) => {
    ...
    return (
        <Fragment>
            ...
            {/* onClick event is to reset the text if closed */}
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-warning mr-2" data-dismiss="modal" onClick={() => editText(todo.todo_id)}>Update</button>
